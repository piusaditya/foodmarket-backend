      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div class="bg-white">
            <table class="table-auto w-full">
              <thead>
                <tr>
                  <th class="border px6 py-6">ID</th>
                  <th class="border px6 py-6">Name</th>
                  <th class="border px6 py-6">Email</th>
                  <th class="border px6 py-6">Roles</th>
                  <th class="border px6 py-6">Action</th>
                </tr>
              </thead>
              <tbody>
